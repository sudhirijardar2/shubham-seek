...
const Diamond = ({ visible, closeCallback, shareOptionCallback, props }) => {
  const popUpData = props;
  console.log('checked', popUpData);
  // const categories = [
  //   {
  //     Key: '45 mins'
  //   },
            ...
            <View
              ...
              >
                <Image
                  ...
                  source={popUpData.images}
                />
              </View>
              <View style={{ marginHorizontal: 20 }}>
                <Text style={{ fontSize: 16, color: '#161616', fontWeight: '700', top: 25 }}>{popUpData.subSalonforWomenName}</Text>
              </View>
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  return (
                    <View>
                      <Text style={{ fontSize: 14, color: '#757575', fontWeight: '400' }}>{'\u2B24' + ' '}{item.description}</Text>
                    </View>
                  )
                }}
              />
